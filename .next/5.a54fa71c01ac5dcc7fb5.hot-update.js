...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  }, "Using Create-React-App as the React rendering engine, we developed an application capable of interacting with our Django backend web services. The designs are based on initial UX wireframes that were adapted to fit unexpected app screens."), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("li", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 61
    }
  }, "The application uses server-side events to render incoming orders in real time. Because the events are needing to be processed as stateless events, I had to greatly leverage functional components to render in real time."), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("li", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 63
    }
  ...
  }, "Using Create-React-App as the rendering engine, we developed an application capable of interacting with our Django backend web services.")))));
});
...
//# sourceMappingURL=5.a54fa71c01ac5dcc7fb5.hot-update.js.map